...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  	\subsection{Asymetrischer Doppeltopf}
  		...
  		die Energien stimmen jedoch für meine Konfiguration mit den gegebenen überein.
  		\small{\begin{tabular}{|c|c|c|c|c|c|} \hline
				\multirow{2}{*}{Potential}  &
					\multicolumn{5}{|c|}{$V(x)= k_0 - k_2 x^2 + k_3 x^3 + k_4 x^4$} \\
				&
					\multicolumn{5}{|c|}{$k_0 = -132.7074997, k_2=7, k_3=.5, k_4=1$} \\ \hline
				\multirow{2}{*}{Parameter}
				& bins   & range      & steps   & runs  & dt \\
				          & $8192$ & ${[-8:8]}$ & $10$    & $50k$ & $0.0001$ \\ \hline
				Start- &
					\multicolumn{5}{|c|}{
						$
							\psi(x) = \mathrm{e}^{\frac{(x-a)^2}{2\sigma^2}}
											+ i \mathrm{e}^{\frac{(x+a)^2}{2\sigma^2}}
						$
					} \\
			...
			\begin{center}\pgfplotstabletypeset[
			...
			]{../simple/spectrum.dat}\end{center}
  	...
  	\subsection{Potentialkasten}
  		...
  		\small{\begin{tabular}{|c|c|c|c|c|c|} \hline
			...
			\begin{center}\pgfplotstabletypeset[
				...
				columns/1/.style={column name=Amplitude, column type={|c|}},
				every last row/.style={after row=\hline},
			]{../square/spectrum.dat}\end{center}
			\lstinputlisting[language=Lua]{../square.lua}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  	\subsection{Potentialkasten: Grundzustand}
			\includegraphics[scale=.62]{../square1/init}
			\includegraphics[scale=.62]{../square1/corr}
			...
			\begin{center}\pgfplotstabletypeset[
				...
				columns/1/.style={column name=Amplitude, column type={|c|}},
				every last row/.style={after row=\hline},
			]{../square1/spectrum.dat}\end{center}
			\lstinputlisting[language=Lua]{../square1.lua}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  	\subsection{Harmonischer Oszillator}
			...
			\begin{center}\pgfplotstabletypeset[
				...
				columns/1/.style={column name=Amplitude, column type={|c|}},
				every last row/.style={after row=\hline},
			]{../harmosca/spectrum.dat}\end{center}
			\lstinputlisting[language=Lua]{../harmosca.lua}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  	\subsection{Harmonischer Oszillator: Grundzustand}
			...
			\begin{center}\pgfplotstabletypeset[
				...
				columns/1/.style={column name=Amplitude, column type={|c|}},
				every last row/.style={after row=\hline},
			]{../harmosc1/spectrum.dat}\end{center}
